...
**Note:** This is a summary or starter guide for learning programming; see this [Python](https://github.com/Aravindray/Python) or [JavaScript](https://github.com/Aravindray/JavaScript) repositories for more in-depth notes.
...
2. [Codewars](https://www.codewars.com/) [Notes: Logged in using Google]
3. [CodePen](https://codepen.io/trending) [Notes: Logged in using Google]
4. [Coding Game](https://www.codingame.com/) [Notes: Logged in using Google]
